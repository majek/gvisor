...
func (n *NIC) enable() *tcpip.Error {
	...
	// Only attempt to generate the link-local address if the stack is
	// configured to auto-generate an IPv6 link-local address, and we have
	// a valid MAC address to generate it from.
	//
